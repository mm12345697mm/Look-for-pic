...
WORKS = [
    ...
    # Fictional mechanic only: this catalog title contains the OCR phrase, so
    # title search of 舌技が神 is supposed to hit. The screenshot 3-upload case
    # is APGH-012 and does not use this id. See tests/test_multi_frame_slots.py.
